...
The dataset was made using the `hex-dissection` tiling method, mentioned in passing in [this presentation](https://dosull.github.io/weavingspace/presentations/NZCS-Aug-2022/slides/#/hexagon-dissections-and-colourings). 
