...
The dataset was made using the `hex-dissection` tiling method, mentioned in passing in [this presentation](https://dosull.github.io/weaving-space/presentations/NZCS-Aug-2022/slides/#/hexagon-dissections-and-colourings). 
...
::: {style="text-indent:-1em;padding:0em 2em 0em 2em;"}
