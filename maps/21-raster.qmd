...
There's a lot more could be said about what I mean by a basic weave pattern, and I could have broken with the 'raster' prompt and made [all kinds of other patterns using the `weavingspace` API](https://github.com/DOSull/weaving-space/examples/blob/main/all-the-tiles.ipynb), as shown below. 
