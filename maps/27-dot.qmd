...
for (i in 1:7) {
  m <- m + 
    tm_shape(layers[[i]]) + 
    tm_bubbles(
      fill = vars[i], size = 0.35, lwd = 0,
      fill.scale = tm_scale_continuous(values = "tol.sunset"),
      fill.legend = tm_legend(
        ...
        width = 8,
        ticks = c(1, 1.1), ticks.col = "white",
        text.color = "white",
        position = tm_pos_in(pos.h = 0.5, pos.v = 0.1, 
                             just.h = 0.0, just.v = 1.0),
        frame = FALSE) )}
m + 
  ...
  tm_text(text = "dimension", size = 0.8,
          options = opt_tm_text(just = c(0.35, 0.5)))+
  tm_credits("Low", position = tm_pos_in(pos.h = 0.422, pos.v = 0.07, just.h = 0, just.v = 0.5)) +
  tm_credits("High", position = tm_pos_in(pos.h = 0.55, pos.v = 0.07, just.h = 0, just.v = 0.5)) +
...
for (i in 1:7) {
  m <- m + 
    ...
    tm_bubbles(
      fill = vars[i], 
      fill.scale = tm_scale_continuous(
        values = "tol.sunset"), size = 0.35, lwd = 0,
      fill.legend = tm_legend(
        variable = "fill",
        show = (i == 1),
        title = "Deprivation",
