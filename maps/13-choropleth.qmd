...
The underlying issue here is that `ggplot2` really doesn't want to make classed choropleths. The data are 'continuous' valued and `ggplot2`'s strong preference is to associate a continuous variable with a continuos visual variable. You can see this if you let it do its own thing:
