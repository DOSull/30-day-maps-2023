...
## The map
`tmap` this time, as there is no point even trying with `ggplot2` this time since it won't allow multiple fill aesthetics to be specified.
